              ...
              <div className="w-full  px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  ...
                  <p className="mt-4 text-lg text-gray-300">
                    Discover more about the types of Pokémons
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="pb-8 lg:pb-16 bg-slate-50 -mt-36">
          <div className="max-w-screen-2xl mx-auto px-4">
            <div className="flex flex-wrap justify-center">
              <div className="relative flex justify-center items-center bg-[#FBA64C] w-[300px] h-[300px] shadow-lg rounded-full">
                <svg
            ...
            <div className="flex flex-col lg:flex-row items-center mt-4 lg:mt-16">
              <div className="w-full lg:w-5/12 px-4 text-center lg:text-left mr-auto ml-auto">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mb-4 text-gray-800">
                  Normal-type Pokémon are versatile and have no specific
                  strengths or weaknesses against other types. They are the
                  standard type in battles, and their moves are neutral against
                  most opponents.
                </p>
                ...
                <p className="strong">
                  ...
                  Are not particularly strong or weak against any type.
                </p>
                ...
                <p className="weak">
                  ...
                  Are not particularly effective against any type.
                </p>
              </div>

              <div className="w-full md:max-w-[600px] px-4 mr-auto ml-auto">
                <div className="relative flex flex-col min-w-0 break-words bg-[#A0A29F] w-full mt-4 lg:mt-0 mb-6 shadow-lg rounded-lg p-8">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    fill="none"
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center mt-4 lg:mt-16">
              ...
              <div className="w-full lg:w-5/12 px-4 mr-auto ml-auto text-center lg:text-left righ">
                <h3 className="text-4xl text-[#CE312F] mb-2 font-semibold leading-normal">
                  Fire Type
                </h3>

                <p className="text-sm lg:text-lg font-light leading-relaxed mt-0 mb-4 text-gray-800">
                  Fire-type Pokémon are known for their fiery attacks. They are
                ...
                <p className="strong">
                  ...
                  Are super effective against Grass, Bug, Ice, and Steel types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                    Weaknesses:
                  </span>{' '}
                  Are weak against Water, Rock, and Ground types.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center mt-4 lg:mt-16">
              <div className="w-full lg:w-5/12 px-4 text-center lg:text-left mr-auto ml-auto">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mb-4 text-gray-800">
                  Water-type Pokémon are associated with aquatic abilities. They
                  are strong against Fire, Ground, and Rock types.
                </p>
                ...
                <p className="strong">
                  ...
                  Are super effective against Fire, Ground, and Rock types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                    Weaknesses:
                  </span>{' '}
                  Are weak against Electric and Grass types.
                </p>
              </div>

              <div className="w-full md:max-w-[600px] px-4 mr-auto ml-auto">
                <div className="relative flex flex-col min-w-0 break-words bg-[#559AD3] w-full mt-4 lg:mt-0 mb-6 shadow-lg rounded-lg p-8">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    fill="none"
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center mt-4 lg:mt-16">
              ...
              <div className="w-full lg:w-5/12 px-4 mr-auto ml-auto text-center lg:text-left righ">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mt-0 mb-4 text-gray-800">
                  Electric-type Pokémon are charged with electricity. They are
                ...
                <p className="strong">
                  ...
                  Are super effective against Water and Flying types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                    Weaknesses:
                  </span>{' '}
                  Are weak against Ground types.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center mt-4 lg:mt-16">
              <div className="w-full lg:w-5/12 px-4 text-center lg:text-left mr-auto ml-auto">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mb-4 text-gray-800">
                  Grass-type Pokémon are associated with plants and nature. They
                  are strong against Water, Ground, and Rock types.
                </p>
                ...
                <p className="strong">
                  ...
                  Are super effective against Water, Ground, and Rock types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                    Weaknesses:
                  </span>{' '}
                  Are weak against Fire, Ice, Poison, Flying, and Bug types.
                </p>
              </div>

              <div className="w-full md:max-w-[600px] px-4 mr-auto ml-auto">
                <div className="relative flex flex-col min-w-0 break-words bg-[#53A93A] w-full mt-4 lg:mt-0 mb-6 shadow-lg rounded-lg p-8">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 512 512"
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center mt-4 lg:mt-16">
              ...
              <div className="w-full lg:w-5/12 px-4 mr-auto ml-auto text-center lg:text-left righ">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mt-0 mb-4 text-gray-800">
                  Ice-type Pokémon have freezing abilities. They are strong
                  against Grass, Ground, Flying, and Dragon types.
                </p>
                ...
                <p className="strong">
                  ...
                  Are super effective against Grass, Ground, Flying, and Dragon
                  types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                  ...
                  Are weak against Fire, Fighting, Rock, and Steel types.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center mt-4 lg:mt-16">
              <div className="w-full lg:w-5/12 px-4 text-center lg:text-left mr-auto ml-auto">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mb-4 text-gray-800">
                  Fighting-type Pokémon are skilled in hand-to-hand combat. They
                  are strong against Normal, Ice, Rock, Dark, and Steel types.
                </p>
                ...
                <p className="strong">
                  ...
                  Are super effective against Normal, Ice, Rock, Dark, and Steel
                  types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                  ...
                  Are weak against Flying, Psychic, and Fairy
                </p>
              </div>

              <div className="w-full md:max-w-[600px] px-4 mr-auto ml-auto">
                <div className="relative flex flex-col min-w-0 break-words bg-[#B73E33] w-full mt-4 lg:mt-0 mb-6 shadow-lg rounded-lg p-8">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    fill="none"
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center mt-4 lg:mt-16">
              ...
              <div className="w-full lg:w-5/12 px-4 mr-auto ml-auto text-center lg:text-left righ">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mt-0 mb-4 text-gray-800">
                  Poison-type Pokémon use toxic attacks. They are strong against
                ...
                <p className="strong">
                  ...
                  Are super effective against Grass and Fairy types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                    Weaknesses:
                  </span>{' '}
                  Are weak against Ground and Psychic types.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center mt-4 lg:mt-16">
              <div className="w-full lg:w-5/12 px-4 text-center lg:text-left mr-auto ml-auto">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mb-4 text-gray-800">
                  Ground-type Pokémon are associated with the earth. They are
                  strong against Fire, Electric, Poison, Rock, and Steel types.
                </p>
                ...
                <p className="strong">
                  ...
                  Are super effective against Fire, Electric, Poison, Rock, and
                  Steel types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                  ...
                  Are weak against Water, Ice, and Grass types.
                </p>
              </div>

              <div className="w-full md:max-w-[600px] px-4 mr-auto ml-auto">
                <div className="relative flex flex-col min-w-0 break-words bg-[#D7BC6D] w-full mt-4 lg:mt-0 mb-6 shadow-lg rounded-lg p-8">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    fill="none"
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center mt-4 lg:mt-16">
              ...
              <div className="w-full lg:w-5/12 px-4 mr-auto ml-auto text-center lg:text-left righ">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mt-0 mb-4 text-gray-800">
                  Flying-type Pokémon are airborne and have aerial abilities.
                  They are strong against Grass, Fighting, and Bug types.
                </p>
                ...
                <p className="strong">
                  ...
                  Are super effective against Grass, Fighting, and Bug types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                    Weaknesses:
                  </span>{' '}
                  Are weak against Electric, Ice, and Rock types.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center mt-4 lg:mt-16">
              <div className="w-full lg:w-5/12 px-4 text-center lg:text-left mr-auto ml-auto">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mb-4 text-gray-800">
                  Bug-type Pokémon are often associated with insects. They are
                ...
                <p className="strong">
                  ...
                  Are super effective against Grass, Psychic, and Dark types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                    Weaknesses:
                  </span>{' '}
                  Are weak against Fire, Flying, and Rock types.
                </p>
              </div>

              <div className="w-full md:max-w-[600px] px-4 mr-auto ml-auto">
                <div className="relative flex flex-col min-w-0 break-words bg-[#D8DE58] w-full mt-4 lg:mt-0 mb-6 shadow-lg rounded-lg p-8">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 512 512"
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center mt-4 lg:mt-16">
              ...
              <div className="w-full lg:w-5/12 px-4 mr-auto ml-auto text-center lg:text-left righ">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mt-0 mb-4 text-gray-800">
                  Dark-type Pokémon are often portrayed as mysterious or
                  villainous. They are strong against Psychic and Ghost types.
                </p>
                ...
                <p className="strong">
                  ...
                  Are super effective against Psychic and Ghost types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                    Weaknesses:
                  </span>{' '}
                  Are weak against Fighting, Bug, and Fairy types.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center mt-4 lg:mt-16">
              <div className="w-full lg:w-5/12 px-4 text-center lg:text-left mr-auto ml-auto">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mb-4 text-gray-800">
                  Rock-type Pokémon are known for their sturdy and rocky
                  exteriors. They are strong against Fire, Ice, Flying, and Bug
                  types.
                </p>
                ...
                <p className="strong">
                  ...
                  Are super effective against Fire, Ice, Flying, and Bug types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                    Weaknesses:
                  </span>{' '}
                  Are weak against Water, Grass, Fighting, Ground, and Steel
                  types.
                </p>
              </div>

              <div className="w-full md:max-w-[600px] px-4 mr-auto ml-auto">
                <div className="relative flex flex-col min-w-0 break-words bg-[#845C39] w-full mt-4 lg:mt-0 mb-6 shadow-lg rounded-lg p-8">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    fill="none"
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center mt-4 lg:mt-16">
              ...
              <div className="w-full lg:w-5/12 px-4 mr-auto ml-auto text-center lg:text-left righ">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mt-0 mb-4 text-gray-800">
                  Steel-type Pokémon are characterized by their metallic bodies.
                  They are strong against Ice, Rock, and Fairy types.
                </p>
                ...
                <p className="strong">
                  ...
                  Are super effective against Ice, Rock, and Fairy types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                    Weaknesses:
                  </span>{' '}
                  Are weak against Fire, Fighting, and Ground types.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center mt-4 lg:mt-16">
              <div className="w-full lg:w-5/12 px-4 text-center lg:text-left mr-auto ml-auto">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mb-4 text-gray-800">
                  Ghost-type Pokémon are often associated with the supernatural.
                  They are strong against Psychic and Ghost types.
                </p>
              ...
              <div className="w-full md:max-w-[600px] px-4 mr-auto ml-auto">
                <div className="relative flex flex-col min-w-0 break-words bg-[#8474B3] w-full mt-4 lg:mt-0 mb-6 shadow-lg rounded-lg p-8">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    fill="none"
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center mt-4 lg:mt-16">
              ...
              <div className="w-full lg:w-5/12 px-4 mr-auto ml-auto text-center lg:text-left righ">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mt-0 mb-4 text-gray-800">
                  Psychic-type Pokémon have psychic abilities. They are strong
                  against Fighting and Poison types.
                </p>
                ...
                <p className="strong">
                  ...
                  Are super effective against Fighting and Poison types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                    Weaknesses:
                  </span>{' '}
                  Are weak against Dark and Ghost types.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center mt-4 lg:mt-16">
              <div className="w-full lg:w-5/12 px-4 text-center lg:text-left mr-auto ml-auto">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mb-4 text-gray-800">
                  Dragon-type Pokémon are powerful and often associated with
                  mythical creatures. They are strong against Dragon types.
                </p>
                ...
                <p className="strong">
                  ...
                  Are super effective against Dragon types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                    Weaknesses:
                  </span>{' '}
                  Are weak against Ice, Fairy, and Dragon types.
                </p>
              </div>

              <div className="w-full md:max-w-[600px] px-4 mr-auto ml-auto">
                <div className="relative flex flex-col min-w-0 break-words bg-[#50A495] w-full mt-4 lg:mt-0 mb-6 shadow-lg rounded-lg p-8">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    fill="none"
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center mt-4 lg:mt-16">
              ...
              <div className="w-full lg:w-5/12 px-4 mr-auto ml-auto text-center lg:text-left righ">
                ...
                <p className="text-sm lg:text-lg font-light leading-relaxed mt-0 mb-4 text-gray-800">
                  Fairy-type Pokémon are known for their enchanting and magical
                  abilities. They are strong against Fighting, Dragon, and Dark
                  types.
                </p>
                <p className="strong">
                  <span className="text-green-500 text-lg font-bold">
                  ...
                  Are super effective against Fighting, Dragon, and Dark types.
                </p>
                <p className="weak">
                  <span className="text-red-500 text-lg font-bold">
                    Weaknesses:
                  </span>{' '}
                  Are weak against Poison and Steel types.
                </p>
              </div>
            </div>
          </div>
